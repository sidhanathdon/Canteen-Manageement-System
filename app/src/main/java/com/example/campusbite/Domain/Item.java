...
public class Item {
    String  oh_title,oh_itemFee,oh_totalFee,oh_date,oh_time,og_itemNo;
    String oh_pic;

    public Item(String oh_title, String oh_itemFee, String oh_totalFee, String oh_date, String oh_time, String oh_pic, String og_itemNo) {
